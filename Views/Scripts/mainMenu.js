...
function menu() {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch('http://localhost/GESTOR_PRODUCTOS/Controllers/usersController.php/actualUserMoney',{
        ...
        fetch("http://localhost/GESTOR_PRODUCTOS/Controllers/productsController.php")
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            products.forEach(product => {
                ...
                comprarButton.addEventListener('click', () => {
                    ...
                    fetch("http://localhost/GESTOR_PRODUCTOS/Controllers/boughtItemsController.php",{
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmReload').addEventListener('click', function() {
        ...
        fetch("http://localhost/GESTOR_PRODUCTOS/Controllers/usersController.php/money",{
...
document.getElementById("actu_botom").addEventListener('click',()=>{
    ...
    fetch("http://localhost/GESTOR_PRODUCTOS/Controllers/usersController.php",{
...
document.getElementById("hyst").addEventListener("click", () => {
    ...
    fetch("http://localhost/GESTOR_PRODUCTOS/Controllers/boughtItemsController.php/allFromID", {
